...
func (i impl) CreateRelationship(ctx context.Context, relationship models.Relationship) (models.Relationship, error) {
	...
	tx := i.gormDB.Exec(`INSERT INTO public.relationship(addressee_id,requester_id,type,id) VALUES(?,?,?,?)`, relationship.AddresseeID, relationship.RequesterID, relationship.Type, relationship.ID)
	if tx.Error != nil {
